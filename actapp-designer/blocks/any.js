/**
 * Block Widget: any.js - Semantic UI Any
 * 
 ...
 *
 * This any and all notices must be kept intact.
 *
 ...
 */
 ...
 ( function ( wp, ActionAppCore ) {
    ...
    var info = {
        ...
        title: 'UI Any',
        example: {
            attributes: {color: 'blue',text: 'Any Text', size: 'large'}
        },
    ...
    function getContent(theProps, theIsEditMode){
        ...
        if( theIsEditMode ){
            ...
            if( !(tmpAtts.mediaURL) ){
                tmpEl = el('div',{className:'ui message compact small orange'},'Select any on sidebar');
            }
    ...
    wp.blocks.registerBlockType( info.category + '/' + info.name, {
        ...
        edit: function ( props ) {
            ...
            var tmpStandardProperties = [
                BlockEditor.getStandardProperty(props,{mediaID:'mediaID',mediaURL:'mediaURL'}, 'Any', 'any' ),
            ...
            var tmpSidebarPanels = [
                BlockEditor.getSidebarPanel('Any Options', tmpStandardProperties),
